...
:onlineusers (get latest online users value) (SERVER-SIDE COMMAND, USE AT OWN RISK)
...
:unitybadges (get unity exclusive badges) (SERVER-SIDE COMMAND, USE AT OWN RISK)
...
:forcedmute Username (force a 72-hour user mute) (SERVER-SIDE COMMAND, USE AT OWN RISK)
:afk (toggle anti afk mode)
:respect (give respects to clicked user) (SERVER-SIDE COMMAND, USE AT OWN RISK)
:givegem Amount (give gems to clicked user) (SERVER-SIDE COMMAND, USE AT OWN RISK)
:clone (clone clicked user look) (SERVER-SIDE COMMAND, USE AT OWN RISK)
...
:calendar (open calendar) (SERVER-SIDE COMMAND, USE AT OWN RISK)
